export const content = [
  {
    ...
    alt: 'Alt cinema',
    badge: 'Test 1',
    title: 'Create photography ideas from smart devices',
    author: {
      name: 'Milena Almeida',
  ...
  },
  {
    ...
    alt: 'Alt cinema',
    badge: 'Test 3',
    title: 'Create photography ideas from smart',
    author: {
      name: 'Mateus Silva',
  ...
  },
  {
    ...
    alt: 'Alt cinema',
    badge: 'Test 4',
    title: 'every photographer needs time to shoot this photo',
    author: {
      name: 'Mateus Silva',
      image: 'https://github.com/maateusilva.png',
      date: '10 de maio, 2023'
